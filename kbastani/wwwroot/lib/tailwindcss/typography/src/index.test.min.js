 ...
 * Original file: /npm/@tailwindcss/typography@0.5.2/src/index.test.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
const path=require("path"),tailwind=require("tailwindcss"),postcss=require("postcss"),typographyPlugin=require(".");let html=String.raw,css=String.raw;function run(e,o=tailwind){let{currentTestName:r}=expect.getState();return e={plugins:[typographyPlugin],corePlugins:{preflight:!1},...e},postcss(o(e)).process(["@tailwind base;","@tailwind components;","@tailwind utilities"].join("\n"),{from:`${path.resolve(__filename)}?test=${r}`})}test("specificity is reduced with :where",(async()=>run({content:[{raw:html`<div class="prose"></div>`}],theme:{typography:{DEFAULT:{css:[{color:"var(--tw-prose-body)",maxWidth:"65ch",'[class~="lead"]':{color:"var(--tw-prose-lead)"},strong:{color:"var(--tw-prose-bold)",fontWeight:"600"},'ol[type="A"]':{listStyleType:"upper-alpha"},"blockquote p:first-of-type::before":{content:"open-quote"},"blockquote p:last-of-type::after":{content:"close-quote"},"h4 strong":{fontWeight:"700"},"figure > *":{margin:0},"ol > li::marker":{fontWeight:"400",color:"var(--tw-prose-counters)"},"> ul > li p":{marginTop:"16px",marginBottom:"16px"},"code::before":{content:'"&#96;"'},"code::after":{content:'"&#96;"'}}]}}}}).then((e=>{expect(e.css).toMatchFormattedCss(css`
      .prose {
    ...
    `)})))),test("modifiers",(async()=>run({content:[{raw:html`<div class="prose prose-lg"></div>`}],theme:{typography:{DEFAULT:{css:[{color:"var(--tw-prose-body)",maxWidth:"65ch",'[class~="lead"]':{color:"var(--tw-prose-lead)"},strong:{color:"var(--tw-prose-bold)",fontWeight:"600"},'ol[type="A"]':{listStyleType:"upper-alpha"},"blockquote p:first-of-type::before":{content:"open-quote"},"blockquote p:last-of-type::after":{content:"close-quote"},"h4 strong":{fontWeight:"700"},"figure > *":{margin:0},"ol > li::marker":{fontWeight:"400",color:"var(--tw-prose-counters)"},"code::before":{content:'"&#96;"'},"code::after":{content:'"&#96;"'}}]},lg:{css:[{fontSize:"18px",lineHeight:"1.75",p:{marginTop:"24px",marginBottom:"24px"},'[class~="lead"]':{fontSize:"22px"},blockquote:{marginTop:"40px",marginBottom:"40px"},h1:{fontSize:"48px",marginTop:"0",marginBottom:"40px"},h2:{fontSize:"30px",marginTop:"56px",marginBottom:"32px"},h3:{fontSize:"24px",marginTop:"40px",marginBottom:"16px"}}]}}}}).then((e=>{expect(e.css).toMatchFormattedCss(css`
      .prose {
        color: var(--tw-prose-body);
        max-width: 65ch;
      }
    ...
    `)})))),test("legacy target",(async()=>run({plugins:[typographyPlugin({target:"legacy"})],content:[{raw:html`<div class="prose"></div>`}],theme:{typography:{DEFAULT:{css:[{color:"var(--tw-prose-body)",maxWidth:"65ch",'[class~="lead"]':{color:"var(--tw-prose-lead)"},strong:{color:"var(--tw-prose-bold)",fontWeight:"600"},'ol[type="A"]':{listStyleType:"upper-alpha"},"blockquote p:first-of-type::before":{content:"open-quote"},"blockquote p:last-of-type::after":{content:"close-quote"},"h4 strong":{fontWeight:"700"},"figure > *":{margin:0},"ol > li::marker":{fontWeight:"400",color:"var(--tw-prose-counters)"},"code::before":{content:'"&#96;"'},"code::after":{content:'"&#96;"'}}]}}}}).then((e=>{expect(e.css).toMatchFormattedCss(css`
      .prose {
        color: var(--tw-prose-body);
        max-width: 65ch;
      }
    ...
    `)})))),test("element variants",(async()=>run({content:[{raw:html`<div
          class="
            prose
            ...
            prose-hr:border-t-2
        "
        ></div>`}],theme:{typography:{DEFAULT:{css:[{color:"var(--tw-prose-body)",'[class~="lead"]':{color:"var(--tw-prose-lead)"},strong:{color:"var(--tw-prose-bold)",fontWeight:"600"},"h4 strong":{fontWeight:"700"}}]}}}}).then((e=>{expect(e.css).toMatchFormattedCss(css`
    ...
    `)})))),test("element variants with custom class name",(async()=>run({plugins:[typographyPlugin({className:"markdown"})],content:[{raw:html`<div
          class="
            markdown
    ...
    `)})))),test("customizing defaults with multiple values does not result in invalid css",(async()=>run({plugins:[typographyPlugin()],content:[{raw:html`<div class="prose"></div>`}],theme:{typography:{DEFAULT:{css:{textAlign:["-webkit-match-parent","match-parent"]}}}}}).then((e=>{expect(e.css).toMatchFormattedCss(css`
      .prose {
        text-align: match-parent;
      }
    `)})))),it("should be possible to use nested syntax (&) when extending the config",(()=>run({plugins:[typographyPlugin()],content:[{raw:html`<div class="prose"></div>`}],theme:{extend:{typography:{DEFAULT:{css:{color:"#000",a:{color:"#888","&:hover":{color:"#ff0000"}}}}}}}}).then((e=>{expect(e.css).toIncludeCss(css`
      .prose {
        color: #000;
        max-width: 65ch;
      }
    `),expect(e.css).toIncludeCss(css`
    ...
    `)}))));
//# sourceMappingURL=/sm/eeaf47551ae8f5f6947c14e6b19dce5a9d5f0adfd11f19ae317509ebf61940fb.map